    ...
    wx.getStorage({
      ...
      complete: function (res) {
        ...
        network.requestLoading(api.order_detail, that.data.params, "GET", '', function (res) {
          ...
          var phoneSecrrct = res.data.info.ordersLogisticsObj.consigneePhone;
          ...
          phoneSecrrct = phoneSecrrct.substr(0, 3) + '****' + phoneSecrrct.substr(7);
          ...
          that.setData({
            ...
            secretPhoneNumber: phoneSecrrct
          })
